        ...
        <div class="scroll-sidebar">
            <nav class="sidebar-nav">
                <ul id="sidebarnav">
                    ...
                    <li> <a href="{{ url('/team_member') }}" ><span> <i class="fas fa-user-friends"></i> </span><span class="hide-menu">Team</span></a></li>
                    ...
                    <li> <a href="{{ url('/photo') }}" ><span> <i class="fas fa-image"></i> </span><span class="hide-menu">Photo</span></a></li>
                </ul>
            </nav>
        </div>
    </aside>
