    ...
    <div class="row">
        ...
        <div class="col-md-4 thumbnail-container">
            ...
            <div class="thumbnail-middle">
                ...
                <h3 class="thumbnail-subtitle"> {{ $CoursesData->course_fee }} </h3>
                <h4 class="thumbnail-subtitle"> {{ $CoursesData->course_totalenroll }} </h4>
                <h5 class="thumbnail-subtitle"> {{ $CoursesData->course_totalclass }} </h5>
